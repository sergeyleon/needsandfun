...
class Articlecategory extends \ActiveRecord\Model implements Humanizeurl
{    
    ...
    static $has_many = array(
        array('articles', 'foreign_key' => 'category_id')
    );
    ...
    {
        $url = \Core\Router::get()->generate('articles_category', array('category' => $this->encoded_key));
        return $url;
    }
