...
class Eventcategory extends \ActiveRecord\Model implements Humanizeurl
{
    public $children;
    ...
    static $table = 'event_categories';
    static $has_many = array(
        array('events', 'foreign_key' => 'category_id')
    );
    ...
    {
        $url = \Core\Router::get()->generate('events_category', array('category' => $this->encoded_key));
        return $url;
    }
